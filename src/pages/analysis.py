...
layout = html.Div(
    children=[
        dbc.Row(
            children=[dbc.Col(html.H3(children="Analysis"), width=2),
                      dbc.Col(
        ...
        dbc.Row(
            children=[
                dbc.Col(
                    children=[dcc.Graph(id="invest_chart")],
                    width=3

                ),
                dbc.Col(
                    children=[dcc.Graph(id="stocks_chart")],
                    width=3
                ),
                dbc.Col(
                    children=[dcc.Graph(id="wsb_chart")],
                    width=3
                ),
                dbc.Col(
                    children=[dcc.Graph(id="twitter_search")],
                    width=3
                ),
            ],
            className="g-0",
