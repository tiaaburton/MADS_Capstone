    ...
    def return_portfolio(holdings, securities):
        ...
        for sec in securities:
            if sec['type'] != 'derivative':
                ...
                sec_quant = [holding['quantity'] for holding in holdings if
                             (holding['security_id'] == sec['security_id'])]
                sec_value = [holding['institution_value'] for holding in holdings if
                             (holding['security_id'] == sec['security_id'])]
